...
if __name__ == "__main__":
    ...
    for data in data_load:
        ...
        for product in products:
            ...
            list_products.append(cls_product)
        category_data.products = list_products
        list_category.append(category_data)
print(list_category[0].name)
print(list_category[0].products[0].name)
